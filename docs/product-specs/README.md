...
### 1. [数据状态模型与序列化 (State & Data Models)](file:///Users/nam/Documents/agent/deep-research/product-specs/state_models.md)
...
### 2. [多智能体协作与 Prompt 设计 (Multi-Agent & Prompts)](file:///Users/nam/Documents/agent/deep-research/product-specs/multi_agents.md)
...
### 3. [异步递归事件循环机制 (Async Event Loop)](file:///Users/nam/Documents/agent/deep-research/product-specs/async_loop.md)
...
### 4. [审计链路与追踪拦截器 (Logging & Tracing)](file:///Users/nam/Documents/agent/deep-research/product-specs/logging_tracing.md)
